...
public class ManualPayment extends PanacheEntityBase {
    @Id
    ...
    public ManualPayment(Long paymentCodeId, Long adminId, String imageBase64, BigDecimal amountPen, String yapeNumber) {
